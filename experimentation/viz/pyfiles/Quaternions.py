"""
This is Dan Holden's code inherited from Ian Mason's codebase from which I started the project.
Best assume all copyright belongs to Dan Holden unless you find otherwise.

Ideally this would be rewritten in Julia, but no need due to PyCall.
"""
...
class Quaternions:
    ...
    def to_pivots(self, forward="z", plane="xz"):
        ds = np.zeros(self.shape + (3,))
